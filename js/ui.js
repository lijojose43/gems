...
class UIManager {
    ...
    async handleFileSelect(file) {
        try {
            ...
            if (result.errors.length > 0) {
                this.showToast(`Imported ${result.students.length} students with ${result.errors.length} errors`, 'warning');
                console.warn('Import errors:', result.errors);
            } else {
                this.showToast(`Successfully imported ${result.students.length} students`, 'success');
            }
    ...
    createStudentCard(student) {
        ...
        const remarksText = student.remarks && student.remarks.length > 0
